...
<?php
	if(isset($_REQUEST['submit']))
	{
		...
		{		
			...
			$qry_p="insert into sub_sale(s_id,s_date,s_name,st_name,s_bag,s_kg,s_rate,s_value) values('".$m_id."','".$t1."','".$t2."','".$p1."','".$p2."','".$p3."','".$p4."','".$p5."')";
			...
			$qry_up="update stock_detail SET stock_bag=$row_stock[1] - '".$p2."', stock_kg=$row_stock[2] - '".+$p3."', total_kg=$row_stock[3] - '".+$p."' where stock_name='$p1'";
...
<div id="sub-header">
        ...
        <h2>New Sale</h2>
                ...
                <td width="15%">
                 <input class="des_q" type="text" name="r[]" id="r" value=""><br>
                </td>
                <td width="15%">
                 <input class="des_q" type="text" name="rate[]" id="rate" value="" onKeyUp="getValues()"><br>
                </td>
                <td width="15%">
